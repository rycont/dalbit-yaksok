...
Deno.test('Standard loop emits warning after exceeding 256 iterations', async () => {
...
Deno.test('Count loop emits warning after exceeding 256 iterations', async () => {
    const warnings: WarningEvent[] = []
...
Deno.test('List loop emits warning after exceeding 256 iterations', async () => {
    const warnings: WarningEvent[] = []
