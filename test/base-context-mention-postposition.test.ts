...
Deno.test('base context variable used in mention with postposition splitting', async () => {
    let output = ''
...
Deno.test('base context variable does not leak into mentioned module exported rules', async () => {
    let output = ''
